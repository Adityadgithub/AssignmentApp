...
extension UsersQueryWhereSort on QueryBuilder<Users, Users, QWhere> {
  QueryBuilder<Users, Users, QAfterWhere> anyId() {
...
extension UsersQueryWhere on QueryBuilder<Users, Users, QWhereClause> {
  QueryBuilder<Users, Users, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Users, Users, QAfterWhereClause> idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Users, Users, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Users, Users, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Users, Users, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension UsersQueryFilter on QueryBuilder<Users, Users, QFilterCondition> {
  ...
  QueryBuilder<Users, Users, QAfterFilterCondition> idEqualTo(Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
        value: value,
  ...
  QueryBuilder<Users, Users, QAfterFilterCondition> idGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Users, Users, QAfterFilterCondition> idLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Users, Users, QAfterFilterCondition> idBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UsersQuerySortThenBy on QueryBuilder<Users, Users, QSortThenBy> {
  ...
  QueryBuilder<Users, Users, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<Users, Users, QAfterSortBy> thenByIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UsersQueryProperty on QueryBuilder<Users, Users, QQueryProperty> {
  QueryBuilder<Users, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
